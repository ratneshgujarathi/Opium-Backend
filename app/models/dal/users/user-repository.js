...
const { APIError, ValidationError, LogicError } = require('../../../../helpers/error-helper/Error');
...
async function createUser(params) {
    ...
    if (userCheck) {
        throw new LogicError({ name: 'already exist', description: "Username/Email already exists" });
    } else {
...
const verifyUser = async (params) => {
    ...
    if (userCheck) {
        ...
        if (isVerifiedPassword) {
            ...
            throw new LogicError({ name: "Wrong Attempt", description: "Attempted Password is Wrong" });
        }
    } else {
        throw new LogicError({ name: "not found", description: "User Not Found" })
    }
